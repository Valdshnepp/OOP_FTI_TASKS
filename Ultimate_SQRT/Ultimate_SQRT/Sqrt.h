...
// Нехорошо наследоваться от stl. В предыдущем семестре должны были про это сказать. Сделай все без наследования от std::false_type.
// Есть альтернатива с композициейю
